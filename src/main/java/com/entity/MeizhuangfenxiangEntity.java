...
public class MeizhuangfenxiangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public MeizhuangfenxiangEntity() {
		
	}
	
	public MeizhuangfenxiangEntity(T t) {
		try {
	...
	private String meizhuangshipin;
	 ...
	 * 设置：美妆视频
	 */
	public void setMeizhuangshipin(String meizhuangshipin) {
		this.meizhuangshipin = meizhuangshipin;
	}
	/**
	 * 获取：美妆视频
	 */
	public String getMeizhuangshipin() {
		return meizhuangshipin;
	}
	/**
	 * 设置：分享内容
	 */
